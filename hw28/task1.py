...
# Словарь содержит, имя пользователя name, его email, телефонный номер phone и свойство
# favorite — избранный контакт или нет.
#
# Разработайте две функции для сериализации и десериализации списка контактов с помощью пакета
# pickle и хранения полученных данных в бинарном файле.
#
# Первая функция write_contacts_to_file принимает два параметра: filename — имя файла,
# contacts — список контактов. Она сохраняет указанный список в файл, используя метод dump пакета pickle.
#
